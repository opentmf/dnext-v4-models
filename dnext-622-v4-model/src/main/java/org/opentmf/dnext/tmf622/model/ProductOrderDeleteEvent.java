...
import org.opentmf.tmf622.model.IProductOrderDeleteEvent;
...
@Getter
@Setter
public class ProductOrderDeleteEvent extends DNextEventBase implements IProductOrderDeleteEvent {
   ...
   */
  private @Valid ProductOrderDeleteEventPayload event;
