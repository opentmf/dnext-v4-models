...
import org.opentmf.tmf676.model.IRefundCreateEvent;
...
@Getter
@Setter
public class RefundCreateEvent extends DNextEventBase implements IRefundCreateEvent {
   ...
   */
  private @Valid RefundCreateEventPayload event;
