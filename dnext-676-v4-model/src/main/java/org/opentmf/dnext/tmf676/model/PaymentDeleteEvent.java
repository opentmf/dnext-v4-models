...
import org.opentmf.tmf676.model.IPaymentDeleteEvent;
...
@Getter
@Setter
public class PaymentDeleteEvent extends DNextEventBase implements IPaymentDeleteEvent {
   ...
   */
  private @Valid PaymentDeleteEventPayload event;
