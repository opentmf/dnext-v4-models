...
import org.opentmf.tmf637.model.IProductCreateEvent;
...
@Getter
@Setter
public class ProductCreateEvent extends DNextEventBase implements IProductCreateEvent {
   ...
   */
  private @Valid ProductCreateEventPayload event;
