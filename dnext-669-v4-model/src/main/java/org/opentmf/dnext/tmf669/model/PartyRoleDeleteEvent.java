...
import org.opentmf.tmf669.model.IPartyRoleDeleteEvent;
...
@Getter
@Setter
public class PartyRoleDeleteEvent extends DNextEventBase implements IPartyRoleDeleteEvent {
   ...
   */
  private @Valid PartyRoleDeleteEventPayload event;
