...
import org.opentmf.tmf669.model.IPartyRoleCreateEvent;
...
@Getter
@Setter
public class PartyRoleCreateEvent extends DNextEventBase implements IPartyRoleCreateEvent {
   ...
   */
  private @Valid PartyRoleCreateEventPayload event;
