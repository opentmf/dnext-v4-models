...
import org.opentmf.tmf670.model.IPaymentMethodStatusChangeEvent;
...
@Getter
@Setter
public class PaymentMethodStatusChangeEvent extends DNextEventBase implements IPaymentMethodStatusChangeEvent {
   ...
   */
  private @Valid PaymentMethodStatusChangeEventPayload event;
