...
import org.opentmf.tmf666.model.ISettlementAccount;
...
@JsonTypeInfo(
    ...
    defaultImpl = SettlementAccount.class
)
@Required(fields = {"name", "relatedParty"})
public class SettlementAccount extends FinancialAccount implements ISettlementAccount {
