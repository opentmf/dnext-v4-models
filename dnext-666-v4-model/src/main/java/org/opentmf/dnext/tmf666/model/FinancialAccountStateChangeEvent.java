...
import org.opentmf.tmf666.model.IFinancialAccountStateChangeEvent;
...
@Getter
@Setter
public class FinancialAccountStateChangeEvent extends DNextEventBase implements IFinancialAccountStateChangeEvent {
   ...
   */
  private @Valid FinancialAccountStateChangeEventPayload payload;
}