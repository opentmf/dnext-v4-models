...
import org.opentmf.tmf668.model.IPartnershipChangeEvent;
...
@Getter
@Setter
public class PartnershipChangeEvent extends DNextEventBase implements IPartnershipChangeEvent {
   ...
   */
  private @Valid PartnershipChangeEventPayload event;
