...
import org.opentmf.tmf620.model.IProductOfferingCreateEvent;
...
@Getter
@Setter
public class ProductOfferingCreateEvent extends DNextEventBase implements IProductOfferingCreateEvent {
   ...
   */
  private @Valid ProductOfferingCreateEventPayload event;
