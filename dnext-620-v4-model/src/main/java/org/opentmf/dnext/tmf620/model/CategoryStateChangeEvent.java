...
import org.opentmf.tmf620.model.ICategoryStateChangeEvent;
...
@Getter
@Setter
public class CategoryStateChangeEvent extends DNextEventBase implements ICategoryStateChangeEvent {
   ...
   */
  private @Valid CategoryStateChangeEventPayload event;
