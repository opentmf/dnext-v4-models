...
@JsonTypeInfo(
    ...
    defaultImpl = ProductSpecificationDeleteEvent.class
)
public class ProductSpecificationDeleteEvent extends QuoteCreateEventBase implements IProductSpecificationDeleteEvent {
