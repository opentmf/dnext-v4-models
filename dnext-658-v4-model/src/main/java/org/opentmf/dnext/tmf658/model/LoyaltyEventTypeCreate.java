...
import org.opentmf.tmf658.model.ILoyaltyEventTypeCreate;
...
@JsonTypeInfo(
    ...
    defaultImpl = LoyaltyEventTypeCreate.class
)
@Required(fields = {"eventType"})
public class LoyaltyEventTypeCreate extends Entity implements ILoyaltyEventTypeCreate {
