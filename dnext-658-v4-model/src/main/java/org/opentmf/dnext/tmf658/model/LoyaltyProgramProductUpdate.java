...
import org.opentmf.tmf658.model.ILoyaltyProgramProductUpdate;

/**
 * The LoyaltyProgramProduct to be updated.
 *
 * <p><br/>
...
@JsonTypeInfo(
    ...
    defaultImpl = LoyaltyProgramProductUpdate.class
)
@Required(fields = {"loyaltyProgramProductSpec", "validFor", "loyaltyProgramMember", "name", "loyaltyAccount"})
public class LoyaltyProgramProductUpdate extends ProductBase implements ILoyaltyProgramProductUpdate {
