...
import org.opentmf.tmf658.model.ILoyaltyRuleCreateEvent;
...
@Getter
@Setter
public class LoyaltyRuleCreateEvent extends DNextEventBase implements ILoyaltyRuleCreateEvent {
   ...
   */
  private @Valid LoyaltyRuleCreateEventPayload event;
