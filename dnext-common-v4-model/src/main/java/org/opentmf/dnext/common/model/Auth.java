...
public class Auth {
  ...
  private @SafeText String authenticationToken;

  @JsonProperty("groups")
  private List<@SafeText String> groupses;
  ...
  @JsonProperty("roles")
  private List<@SafeText String> roleses;

  @SafeId
  @Size(max = 100)
  private String tenantId;

  private @SafeText String tokenExpiryTime;

  private @SafeText String tokenIssuedTime;

  private @SafeText String tokenIssuer;
