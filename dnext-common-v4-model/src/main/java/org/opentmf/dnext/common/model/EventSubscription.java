...
import org.opentmf.common.model.IEventSubscription;
...
@JsonTypeInfo(
    ...
    defaultImpl = EventSubscription.class
)
@Required(fields = {"callback", "id"})
public class EventSubscription extends EventSubscriptionInput implements IEventSubscription {
