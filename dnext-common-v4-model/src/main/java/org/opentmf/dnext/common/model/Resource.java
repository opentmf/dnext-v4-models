...
public class Resource extends PaymentBase implements IResource {
  ...
  /**
   * Tracks the lifecycle status of the resource, such as standby ,Avilable
   * ,suspended ,terminated ,cancelled and so on.
   */
