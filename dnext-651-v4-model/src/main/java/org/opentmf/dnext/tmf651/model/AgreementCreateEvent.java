...
import org.opentmf.tmf651.model.IAgreementCreateEvent;
...
@Getter
@Setter
public class AgreementCreateEvent extends DNextEventBase implements IAgreementCreateEvent {
   ...
   */
  private @Valid AgreementCreateEventPayload event;
