...
import org.opentmf.tmf651.model.IAgreementStateChangeEvent;
...
@Getter
@Setter
public class AgreementStateChangeEvent extends DNextEventBase implements IAgreementStateChangeEvent {
   ...
   */
  private @Valid AgreementStateChangeEventPayload event;
