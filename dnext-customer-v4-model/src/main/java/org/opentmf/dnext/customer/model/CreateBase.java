...
import org.opentmf.dnext.common.model.RelatedPlace;
...
@JsonTypeInfo(
    ...
    defaultImpl = CreateBase.class
)
public abstract class CreateBase extends Extensible {
