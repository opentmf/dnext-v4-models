...
import org.opentmf.dnext.general.model.GeographicLocationRefOrValue;
import org.opentmf.dnext.general.model.GeographicSubAddress;

/**
 * The GeographicAddress to be updated.
 *
 * <p><br/>
...
@JsonTypeInfo(
    ...
    defaultImpl = GeographicAddressUpdate.class
)
@Required(fields = {"atType"})
public class GeographicAddressUpdate extends Extensible {
