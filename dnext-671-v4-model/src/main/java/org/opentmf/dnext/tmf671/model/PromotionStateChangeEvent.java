...
import org.opentmf.tmf671.model.IPromotionStateChangeEvent;
...
@Getter
@Setter
public class PromotionStateChangeEvent extends DNextEventBase implements IPromotionStateChangeEvent {
   ...
   */
  private @Valid PromotionStateChangeEventPayload event;
