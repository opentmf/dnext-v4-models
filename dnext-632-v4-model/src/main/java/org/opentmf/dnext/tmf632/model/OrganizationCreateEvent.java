...
import org.opentmf.tmf632.model.IOrganizationCreateEvent;
...
@Getter
@Setter
public class OrganizationCreateEvent extends DNextEventBase implements IOrganizationCreateEvent {
   ...
   */
  private @Valid OrganizationCreateEventPayload event;
