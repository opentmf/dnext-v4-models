...
import org.opentmf.tmf632.model.IIndividualDeleteEvent;
...
@Getter
@Setter
public class IndividualDeleteEvent extends DNextEventBase implements IIndividualDeleteEvent {
   ...
   */
  private @Valid IndividualDeleteEventPayload event;
