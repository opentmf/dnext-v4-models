...
import org.opentmf.tmf634.model.IExportJobCreateEvent;
...
@Getter
@Setter
public class ExportJobCreateEvent extends DNextEventBase implements IExportJobCreateEvent {
   ...
   */
  private @Valid ExportJobCreateEventPayload event;
