...
import org.opentmf.tmf634.model.IResourceCategoryChangeEvent;
...
@Getter
@Setter
public class ResourceCategoryChangeEvent extends DNextEventBase implements IResourceCategoryChangeEvent {
   ...
   */
  private @Valid ResourceCategoryChangeEventPayload event;
