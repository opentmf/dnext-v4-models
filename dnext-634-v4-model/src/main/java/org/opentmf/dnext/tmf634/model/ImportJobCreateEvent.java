...
import org.opentmf.tmf634.model.IImportJobCreateEvent;
...
@Getter
@Setter
public class ImportJobCreateEvent extends DNextEventBase implements IImportJobCreateEvent {
   ...
   */
  private @Valid ImportJobCreateEventPayload event;
