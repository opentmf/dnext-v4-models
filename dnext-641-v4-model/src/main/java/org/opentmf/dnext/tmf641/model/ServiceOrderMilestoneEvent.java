...
@JsonTypeInfo(
    ...
    defaultImpl = ServiceOrderMilestoneEvent.class
)
public class ServiceOrderMilestoneEvent extends QuoteCreateEventBase implements IServiceOrderMilestoneEvent {
