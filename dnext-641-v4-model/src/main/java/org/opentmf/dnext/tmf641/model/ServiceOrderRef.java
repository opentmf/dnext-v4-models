...
import org.opentmf.tmf641.model.IServiceOrderRef;
...
@JsonTypeInfo(
    ...
    defaultImpl = ServiceOrderRef.class
)
@Required(fields = {"id"})
public class ServiceOrderRef extends EntityRef implements IServiceOrderRef {
}