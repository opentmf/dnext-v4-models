...
@JsonTypeInfo(
    ...
    defaultImpl = ServiceSpecificationChangeEvent.class
)
public class ServiceSpecificationChangeEvent extends QuoteCreateEventBase implements IServiceSpecificationChangeEvent {
