...
import org.opentmf.tmf633.model.IServiceCategoryCreateEvent;
...
@Getter
@Setter
public class ServiceCategoryCreateEvent extends DNextEventBase implements IServiceCategoryCreateEvent {
   ...
   */
  private @Valid ServiceCategoryCreateEventPayload event;
